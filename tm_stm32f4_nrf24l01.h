 ...
 * 	GND		GND		Ground
 * 	VCC		3.3V		3.3V
 * 	CE		PB11		RF activated pin
 * 	CSN		PB12		SPI2 Pinspack 2 CSN pin
 * 	SCK		PC10		SPI2 Pinspack 2 SCK pin
 * 	MOSI		PC12		SPI2 Pinspack 2 MOSI pin
 * 	MISO		PC11		SPI2 Pinspack 2 MISO pin
